...
<link href="../resources/css/styles.css" type="text/css"
	rel="stylesheet" />
<link href="../resources/css/community.css" type="text/css"
	rel="stylesheet" />
<style>
div {
	text-align: center;
...
<body>
	...
	<div id="category_list">
		...
		<div class="category_list">
			<a class="category" href="../community/bbs1"
				style="text-decoration: none"> <font size="5">자유게시판</font></a>
		</div>
		<div class="category_list">
			<a class="category" href="bbs2" style="text-decoration: none"> <font
				size="5">질문게시판</font></a>
		</div>
		<div class="category_list">
			<a class="category" href="bbs3" style="text-decoration: none"> <font
				size="5">자랑게시판</font></a>
		</div>
		<div class="category_list">
			<a class="category" href="bbs4" style="text-decoration: none"> <font
				size="5">오픈채팅방</font></a>
		</div>
	</div>
	<!-- 임시 화면 -->
