...
<body>
	...
	<div id="insert_button">
		<button onclick="location.href='bbs_insert2'" class="button1">글쓰기</button>
	</div>
	<% } %>
	<!-- 화면 중앙 -->
	...
	<!-- 게시판 검색 -->
	<div id="bbs_one">
		<form action="bbs_one2" method="get">
			<input name="bbs_no" >
	...
	<div id="bbs_list">
		...
		<div class="bbs_post">
			<img src="../resources/assets/upload/${bag.bbs_img}" width=100 height=100><br>
			<div class="bbs_content">
				<h5><a href="bbs_one2?bbs_no=${bag.bbs_no}">${bag.bbs_title}</a></h5><br>
				${bag.bbs_content}
			</div>
		</div>
			<br><br><hr><br><br>
