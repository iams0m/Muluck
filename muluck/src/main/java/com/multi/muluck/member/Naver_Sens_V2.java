...
public class Naver_Sens_V2 {
	...
	public void send_msg(String tel, String rand) {
        ...
        // 개인 인증키
        String accessKey = "8E1C0oOhZHftKCVrrZcv";
        // 2차 인증을 위해 서비스마다 할당되는 service secret
        String secretKey = "vRm62ziuJcc8kt27Rz564YBrBNGaLBWX51FN4LYv";
        // 프로젝트에 할당된 SMS 서비스 ID
        String serviceId = "ncp:sms:kr:300404794002:muluck";
        // 요청 method
        String method = "POST";
        ...
        // 난수와 함께 전송
        toJson.put("content","[muluck] 본인인증 ["+rand+"]");		
        toJson.put("to",tel);
        toArr.add(toJson);
        ...
        bodyJson.put("content","내용common");
        bodyJson.put("countryCode","82");
        
        // 발신번호 * 사전에 인증/등록된 번호만 사용할 수 있습니다.
        bodyJson.put("from","01063729818");		
